...
export const potStyles = [
  { id: "classic", name: "Classic Ceramic", description: "Bề mặt men gốm mịn màng, thanh lịch." },
  { id: "earthenware", name: "Earthenware Pot", description: "Gốm mộc thô nhám phong cách truyền thống." },
  { id: "grow-pot", name: "Plastic Grow Pot", description: "Chậu nhựa ươm cây đơn giản, tiện lợi." }
];

export const potColors = [
  { name: "Terracotta", value: "#D77A61", tailwindBg: "bg-[#D77A61]" },
  { name: "Cream", value: "#F5F2EB", tailwindBg: "bg-[#F5F2EB]" },
  { name: "Mint", value: "#C1D5C0", tailwindBg: "bg-[#C1D5C0]" },
  { name: "Charcoal", value: "#3E3E3E", tailwindBg: "bg-[#3E3E3E]" }
];
