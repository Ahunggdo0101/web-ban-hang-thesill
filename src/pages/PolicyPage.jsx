  ...
  switch (type) {
      ...
      content = (
        <div className="space-y-8">
          <p className="lead text-base sm:text-lg text-brand-slate italic font-medium">
            Tại The Sill, chúng tôi hiểu rằng việc vận chuyển sinh vật sống yêu cầu sự chăm sóc và kỹ thuật đặc biệt. 
          ...
          <section className="space-y-4">
            ...
            <p className="text-xs sm:text-sm text-brand-slate leading-relaxed font-medium">
              ...
              Đặc biệt, The Sill áp dụng chương trình <strong>miễn phí vận chuyển tiêu chuẩn cho tất cả các đơn hàng từ 150.000đ trở lên</strong>.
            </p>
          </section>
      ...
      content = (
        <div className="space-y-8">
          <p className="lead text-base sm:text-lg text-brand-slate italic font-medium">
            ...
            Mỗi đơn hàng tại The Sill đều được bảo đảm bằng chính sách cam kết chất lượng vượt trội.
          </p>
          ...
          <section className="space-y-4">
            ...
            <p className="text-xs sm:text-sm text-brand-slate leading-relaxed font-medium">
              ...
              The Sill cam kết <strong>1 đổi 1 hoặc hoàn trả sản phẩm miễn phí</strong>.
            </p>
          </section>
    ...
    case 'privacy':
      ...
      content = (
        <div className="space-y-8">
          <p className="lead text-base sm:text-lg text-brand-slate italic font-medium">
            The Sill Việt Nam tôn trọng quyền riêng tư của khách hàng và cam kết bảo vệ tuyệt đối các dữ liệu cá nhân mà bạn đã tin tưởng chia sẻ với chúng tôi.
          </p>
          ...
          <section className="space-y-4">
            ...
            <p className="text-xs sm:text-sm text-brand-slate leading-relaxed font-medium">
              Tất cả các giao dịch thanh toán bằng thẻ tín dụng tại The Sill đều được mã hóa qua giao thức cổng thanh toán bảo mật chuẩn quốc tế. 
